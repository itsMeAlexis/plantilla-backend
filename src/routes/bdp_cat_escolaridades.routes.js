...
import * as bdp_cat_escolaridadesController from '../controllers/bdp_cat_escolaridades.Controller.js';
...
router.get('/', bdp_cat_escolaridadesController.getEscolaridades);
